        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Most competitive pricing without compromising on quality</p>
            </div>
            <div className="text-center">
              <div className="bg-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-md">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Rigorous quality control to guarantee performance and consistency</p>
            </div>
            <div className="text-center">
              <div className="bg-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-md">
                <div className="text-2xl">⚡</div>
              ...
              <p className="text-gray-600">Quick and reliable communication for all your inquiries</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="products" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore our range of premium charcoal products, crafted to meet diverse needs and international standards.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="card card-hover">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Coconut Shell Charcoal Briquettes</h3>
                <p className="text-gray-600 mb-4">Perfect for shisha and hookah. Clean burn, minimal ash, long-lasting heat.</p>
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold text-green-600">$570/ton</span>
            ...
            <div className="card card-hover">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Premium Wood Charcoal</h3>
                <p className="text-gray-600 mb-4">Made from Halaban and Binchotan wood. High heat output and durability.</p>
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold text-green-600">$220/ton</span>
                  <span className="text-sm text-gray-500">Starting from</span>
                </div>
                <ul className="mt-4 space-y-1 text-sm text-gray-600">
            ...
            <div className="card card-hover">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">BBQ Charcoal Briquettes</h3>
                <p className="text-gray-600 mb-4">Consistent heat and clean burn for perfectly cooked meals every time.</p>
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold text-green-600">$650/ton</span>
                  <span className="text-sm text-gray-500">Starting from</span>
                </div>
                <ul className="mt-4 space-y-1 text-sm text-gray-600">
            ...
            <div className="card card-hover">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">Engineered for steady, long-lasting heat. Perfect for restaurants and events.</p>
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold text-green-600">$740/ton</span>
                  <span className="text-sm text-gray-500">Starting from</span>
                </div>
                <ul className="mt-4 space-y-1 text-sm text-gray-600">
      ...
      <section id="quality" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Every batch undergoes rigorous testing and quality control to ensure consistent performance.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-semibold mb-6">Certifications & Documentation</h3>
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="text-green-600 font-semibold">ISO 9001:2015</div>
                  <div className="text-sm text-gray-600">Quality Management</div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="text-green-600 font-semibold">MSDS</div>
                  <div className="text-sm text-gray-600">Material Safety Data</div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="text-green-600 font-semibold">COA</div>
                  <div className="text-sm text-gray-600">Certificate of Analysis</div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="text-green-600 font-semibold">COO</div>
                  <div className="text-sm text-gray-600">Certificate of Origin</div>
                </div>
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-xl font-semibold mb-4">Quality Specifications</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Take your brand to the next level with our OEM services. Custom products, packaging, and branding solutions.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Your brand, your design. We handle all packaging needs.</p>
            </div>
            <div className="text-center">
              <div className="bg-gray-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <div className="text-2xl">🏷️</div>
              ...
              <p className="text-gray-600">Showcase your unique brand with personalized labels.</p>
            </div>
            <div className="text-center">
              <div className="bg-gray-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <div className="text-2xl">🔧</div>
              ...
              <p className="text-gray-600">Tailor shapes, sizes, and compositions to your needs.</p>
            </div>
            <div className="text-center">
              <div className="bg-gray-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <div className="text-2xl">🚀</div>
              ...
              <p className="text-gray-600">From concept to delivery, we handle every detail.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="shipping" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Reliable shipping to over 20 countries with expert logistics and flexible payment terms.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-semibold mb-6">Shipping Destinations & Timeline</h3>
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="flex justify-between items-center">
                    <span className="font-semibold">East Asia (Korea, Japan, China)</span>
                    <span className="text-gray-600">21-35 days</span>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="flex justify-between items-center">
                    <span className="font-semibold">Middle East (UAE, Saudi, Qatar)</span>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Container Options</h4>
          ...
          <div className="text-center">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 max-w-4xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-semibold mb-4">Free Sample Package Includes:</h3>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Samples are FREE - you only pay for shipping via DHL, FedEx, or EMS
                  </p>
                  <Link
                    href="#contact"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Everything you need to know about our charcoal products and services.
            </p>
          </div>
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-lg font-semibold mb-2">What is your minimum order quantity (MOQ)?</h3>
              <p className="text-gray-600">
                Our MOQ is typically 18 tons (20ft container). For established customers, we can accommodate smaller orders. 
                US and Russia customers can order from 1 ton via LCL.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-lg font-semibold mb-2">How do you guarantee product quality?</h3>
              <p className="text-gray-600">
                Every batch undergoes rigorous testing at our ISO 9001:2015 certified facility. We provide independent laboratory 
                reports, certificates of analysis, and complete documentation for each shipment.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-lg font-semibold mb-2">Can you provide custom packaging and branding?</h3>
              <p className="text-gray-600">
                Yes! We offer complete OEM services including custom packaging, private labeling, and product customization. 
                Our in-house printing facility can handle all your branding needs.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-lg font-semibold mb-2">What payment terms do you accept?</h3>
              <p className="text-gray-600">
                We accept various payment methods including T/T (bank transfer), L/C (letter of credit), and multiple currencies 
                (USD, EUR, CNY). Payment terms are flexible based on order size and customer relationship.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-lg font-semibold mb-2">How long does production and shipping take?</h3>
              <p className="text-gray-600">
                Production takes 10-14 days for standard orders. Shipping time varies by destination: 21-35 days to East Asia, 
                30-45 days to Middle East, 38-55 days to Europe, and 30-70 days to North America.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to start your charcoal import business? Contact us today for quotes, samples, or any questions.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Monday - Saturday: 08:00 - 17:00 (GMT+7)<br />
                      Sunday: Closed
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white">Coconut Shell Charcoal</a></li>
                <li><a href="#" className="hover:text-white">Wood Charcoal</a></li>
                <li><a href="#" className="hover:text-white">BBQ Briquettes</a></li>
                <li><a href="#" className="hover:text-white">Sawdust Charcoal</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">Services</h4>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white">OEM Manufacturing</a></li>
                <li><a href="#" className="hover:text-white">Custom Packaging</a></li>
                <li><a href="#" className="hover:text-white">Private Labeling</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#quality" className="hover:text-white">Quality Assurance</a></li>
